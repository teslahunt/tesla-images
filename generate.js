...
const MS_VIEW_ANGLES = ['STUD_3QTR', 'STUD_SIDE', 'STUD_REAR', 'STUD_SEAT_ALTA']
const M3_VIEW_ANGLES = ['STUD_3QTR', 'STUD_SEAT']
const MX_VIEW_ANGLES = ['STUD_3QTR', 'STUD_SIDE', 'STUD_REAR', 'STUD_SEAT']
